...
- **Local incident-review engine** — classifies incidents, builds structured RCA, and serves data routes
- **Replay and eval layer** — deterministic incident cases used as proof and regression gates
- **Local frontend console** — user-facing console with recorded-review fallback
...
| `/api/summary-pack` | user-friendly evidence summary and handoff contract |
